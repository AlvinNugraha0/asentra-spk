...
$icons = [
    ...
    'SlidersHorizontal' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 4h-7"/><path d="M17 20V4"/><path d="M3 14h7"/><path d="M7 20v-6"/><path d="M14 15h7"/><path d="M17 10V4"/></svg>',
...
$iconSvg = $icons[$icon] ?? '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/></svg>';
?>
<li class="nav-item">
    <a href="<?= route($route) ?>" class="nav-link <?= $isActive ? 'active' : '' ?>" aria-label="<?= e($label) ?>">
        <?= $iconSvg ?>
    </a>
    <span class="nav-tooltip"><?= e($label) ?></span>
</li>
