    ...
    <div class="welcome-banner-content">
        <div class="welcome-banner-top">
            ...
            <div class="welcome-banner-actions">
                ...
                <a href="<?= route('/owner/ranking') ?>" class="btn-banner" style="background: rgba(255,255,255,0.15);">
        ...
        <div class="welcome-stats">
            ...
            <div class="welcome-stat">
                ...
                <div class="welcome-stat-value" style="font-size: var(--text-lg);">
                    <?= $topResult ? e($topResult['nama_teknisi']) : '-' ?>
                </div>
            ...
            <div class="welcome-stat">
                ...
                <div class="welcome-stat-value tabular" style="color: var(--brand);">
                    <?= $topResult ? e(scoreFormat((float) $topResult['nilai_preferensi'], 3)) : '-' ?>
                </div>
...
<!-- Progress Penilaian Periode Ini -->
<div class="card mb-5" data-reveal="up" style="margin-top: var(--space-5);">
    ...
    <div style="display: flex; gap: var(--space-4); margin-bottom: var(--space-4); flex-wrap: wrap;">
        <div
            style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-2) var(--space-3); background: var(--bg-surface); border-radius: var(--radius-md); border: 1px solid var(--border); font-size: var(--text-sm);">
            <i class="ph ph-users text-lg" style="color: var(--brand);"></i>
            <span class="tabular font-bold"><?= e((string) $activeTeknisi) ?></span>
            <span class="text-muted">Total</span>
        </div>
        <div
            style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-2) var(--space-3); background: var(--bg-surface); border-radius: var(--radius-md); border: 1px solid var(--border); font-size: var(--text-sm);">
            <i class="ph ph-check-circle text-lg" style="color: var(--success);"></i>
            <span class="tabular font-bold" style="color: var(--success);"><?= e((string) $dinilaiCount) ?></span>
            <span class="text-muted">Sudah Dinilai</span>
        </div>
        <div
            style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-2) var(--space-3); background: var(--bg-surface); border-radius: var(--radius-md); border: 1px solid var(--border); font-size: var(--text-sm);">
            <i class="ph ph-clock text-lg" style="color: var(--warning);"></i>
            <span class="tabular font-bold" style="color: var(--warning);"><?= e((string) $belumDinilaiCount) ?></span>
            <span class="text-muted">Belum Dinilai</span>
        </div>
    </div>
    <div
        style="width: 100%; height: 8px; background: var(--bg-surface); border-radius: 999px; overflow: hidden; border: 1px solid var(--border);">
        <div
            style="height: 100%; background: linear-gradient(90deg, var(--brand), var(--brand-hover, var(--brand))); border-radius: 999px; transition: width 0.6s ease; width: <?= e((string) $progressPct) ?>%;">
        </div>
    </div>
</div>
        ...
        <div class="card" data-reveal="up">
            <div class="section-header" style="align-items: flex-start;">
                <div class="section-header-left">
                    ...
                    <p>Distribusi nilai preferensi (Vi) seluruh teknisi periode <?= e(periodLabel($processedPeriode)) ?>.
                    </p>
                </div>
            ...
            <div style="position: relative; height: <?= max(260, count($results) * 30 + 40) ?>px; width: 100%;">
                <?php if (!$hasResults): ?>
                    <div
                        style="height: 100%; display: flex; align-items: center; justify-content: center; border: 1px dashed var(--border); border-radius: var(--radius-md); background: var(--bg-surface);">
                        <div style="text-align: center; color: var(--text-muted);">
                            <i class="ph ph-chart-bar-horizontal"
                                style="font-size: 2rem; margin-bottom: 8px; opacity: 0.5;"></i>
                            ...
                            <?php foreach (array_slice($results, 0, 5) as $r): ?>
                                <tr>
                                    ...
                                    <td class="font-bold tabular" style="color: var(--brand);">
                                        <?= e(scoreFormat((float) $r['nilai_preferensi'], 3)) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="stack" style="gap: var(--space-6);">
                ...
                <div class="quick-action-grid">
                    ...
                    <a href="<?= route('/owner/assessment?mode=tabulasi') ?>" class="quick-action">
                        ...
                        <span class="quick-action-label">Penilaian Kinerja</span>
                    </a>
