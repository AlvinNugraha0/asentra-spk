...
<div class="kpi-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--space-4); margin-bottom: var(--space-6);">
    <div class="kpi-card">
        ...
        <div class="kpi-value tabular" style="font-size: var(--text-lg);"><?= $latestPeriode ? e(periodLabel($latestPeriode)) : '-' ?></div>
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-value tabular" style="color: var(--gold);"><?= $topResult ? e($topResult['nama_teknisi']) : '-' ?></div>
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-value tabular" style="color: var(--gold);"><?= $topResult ? e(scoreFormat((float) $topResult['nilai_preferensi'], 3)) : '-' ?></div>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php foreach (array_slice($results, 0, 5) as $r): ?>
                        <tr>
                            <td><span class="badge badge-gold"><?= e((string) $r['ranking']) ?></span></td>
                            <td>
