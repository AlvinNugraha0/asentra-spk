#!/usr/bin/env bash
# Phase 6L — full regression runner: 21 PHP suites + 5 Python HTTP suites.
# Adds tests/phase6l_admin_ux_test.php to the Phase 6K set.
set -uo pipefail
cd "D:/Aplikasi/asentra-spk"
PHP="C:/xampp/php/php.exe"
PY="python"
OUT="$LOCALAPPDATA/Temp/phase6l_regression.out"
: > "$OUT"
