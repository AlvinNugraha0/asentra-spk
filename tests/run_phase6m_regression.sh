#!/usr/bin/env bash
# Phase 6M — full regression runner: 22 PHP suites + 5 Python HTTP suites.
# Adds tests/phase6m_import_polish_test.php to the Phase 6L set.
set -uo pipefail
cd "D:/Aplikasi/asentra-spk"
PHP="C:/xampp/php/php.exe"
PY="python"
OUT="$LOCALAPPDATA/Temp/phase6m_regression.out"
: > "$OUT"
...
for f in db_connect_test.php auth_service_test.php password_verify_test.php \
         ...
         phase6m_import_polish_test.php \
